    ...
    <Animation delay={0.4}>
      ...
      >
        <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
          ...
          <h1 className="max-sm:mt-6 mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold">
          ...
          <p className="font-montserrat text-slate-gray dark:text-light-gray text-lg max-sm:text-[16px] leading-8 mt-6 sm:mb-14 max-sm:mb-6 sm:max-w-sm">
